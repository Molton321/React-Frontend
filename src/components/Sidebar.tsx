...
duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 ${
                ...
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <div className="flex ml-3 mb-4 mt-2 justify-start">
                      <li>
                        <NavLink
                          to="/auth/signin"
                          className={({ isActive }) =>
                            'flex bg-[#29D884] hover:bg-[#27b16e] text-white text-s font-semibold rounded-md px-5 py-2 transition-colors duration-200' +
